...
public class TriangularPrism extends Prism
{
	...
	// return string based on compareTpe
	public String output(char compareType) {
		if(compareType == 'v') {
			return "shapes.TriangularPrism\t" + "Volume: " +this.calVolume();
		}
		else if(compareType == 'h') {
			return "shapes.TriangularPrism\t" + "Height: "+ this.getHeight();
		}
		else if(compareType == 'a') {
			return "shapes.TriangularPrism\t" + "Area: "+ this.calBaseArea();
		}
		else {
			return "";
		}
	...
	public String toString() {
		return "TriangularPrism [side=" + side + ", type=" + type + "]";
	}
