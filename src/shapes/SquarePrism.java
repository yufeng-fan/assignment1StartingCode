...
public class SquarePrism extends Prism
{
	...
	public double calVolume() {
		...
		return Math.pow(side, 2) * this.getHeight();
	}
	// calculate the Area
	@Override
	...
	// return String based on compare
	public String output(char compareType) {
		if(compareType == 'v') {
			return "shapes.SquarePrism\t" + "Volume: " +this.calVolume();
		}
		else if(compareType == 'h') {
			return "shapes.SquarePrism\t" + "Height: "+ this.getHeight();
		}
		else if(compareType == 'a') {
			return "shapes.SquarePrism\t" + "Area: "+ this.calBaseArea();
		}
		else {
			return "";
		}
	...
	public String toString() {
		return "SquarePrism [side=" + side + ", type=" + type + "]";
	}
