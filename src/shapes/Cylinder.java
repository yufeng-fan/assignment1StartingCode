...
public class Cylinder extends Shape
{
	...
	public double calVolume() {
		...
		return PI * Math.pow(radius, 2) * this.getHeight();
	}
	// calculate the area
	@Override
	...
	// return string ouput based on the compareType parameter
	public String output(char compareType) {
		if(compareType == 'v') {
			return "shapes.Cylinder\t\t" + "Volume: " +this.calVolume();
		}
		else if(compareType == 'h') {
			return "shapes.Cylinder\t\t" + "Height: "+ this.getHeight();
		}
		else if(compareType == 'a') {
			return "shapes.Cylinder\t\t" + "Area: "+ this.calBaseArea();
		}
		else {
			return "";
		}
	...
	public String toString() {
		return "Cylinder [radius=" + radius + ", type=" + type + "]";
	}
