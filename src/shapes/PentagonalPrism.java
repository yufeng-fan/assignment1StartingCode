...
public class PentagonalPrism extends Prism
{
	...
	public String output(char compareType) {
		if(compareType == 'v') {
			return "shapes.PentagonalPrism\t" + "Volume: " +this.calVolume();
		}
		else if(compareType == 'h') {
			return "shapes.PentagonalPrism\t" + "Height: "+ this.getHeight();
		}
		else if(compareType == 'a') {
			return "shapes.PentagonalPrism\t" + "Area: "+ this.calBaseArea();
		}
		else {
			return "";
		}
	...
	public String toString() {
		return "PentagonalPrism [side=" + side + ", type=" + type + "]";
	}
